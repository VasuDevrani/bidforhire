...
export const UNLOCK_PRICE_CENTS = Number(process.env.UNLOCK_PRICE_CENTS) || 500; // $5 — kept for legacy orders only
export const LIFETIME_ACCESS_PRICE_CENTS = 1000; // $10 — one-time fee for unlimited unlocks
